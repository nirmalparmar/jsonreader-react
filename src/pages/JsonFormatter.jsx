...
const JsonFormatter = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>JSON Formatter Online - Beautify, Validate, and Edit JSON</title>
        <meta
          name="description"
          content="Use JSON Formatter by JSONReader to easily format, beautify, and validate JSON data online. A powerful tool for developers and data enthusiasts."
        />
        <meta
          name="keywords"
          content="JSON formatter online, JSON beautifier, JSON validator, edit JSON, format JSON, online JSON editor"
        />
        <meta name="author" content="JSONReader Team" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.jsonreader.com/json-formatter" />
        <meta
          property="og:title"
          content="JSON Formatter Online - Beautify, Validate, and Edit JSON"
        />
        <meta
          property="og:description"
          content="Easily format and validate JSON data with JSONReader's online JSON formatter. Simple, fast, and effective for developers."
        />
        <meta
          property="og:url"
          content="https://www.jsonreader.com/json-formatter"
        />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://www.jsonreader.com/json-formatter-preview.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="JSON Formatter Online - Beautify, Validate, and Edit JSON" />
        <meta name="twitter:description" content="Easily format and validate JSON data with JSONReader's online JSON formatter." />
        <meta name="twitter:image" content="https://www.jsonreader.com/json-formatter-preview.png" />
      </Helmet>

      <main style={{ padding: '20px', textAlign: 'center' }}>
        <header>
          <Title level={1}>JSON Formatter Online</Title>
          <Paragraph>
            Welcome to the ultimate JSON Formatter tool! Paste your JSON data below, 
